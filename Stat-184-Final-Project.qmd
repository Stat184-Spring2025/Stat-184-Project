...
ggplot(df_summary, aes(x = reorder(main_category, -avg_rating), 
       y = avg_rating, fill = main_category)) +
...
# Note: Outlier users with ~600 and ~50 items offsetting all data points, removed for ease of understanding 
